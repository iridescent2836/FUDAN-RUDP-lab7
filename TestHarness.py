...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest, RandomDisorderTest, SackRandomDisorderTest, RandomDuplicateTest, SackRandomDuplicateTest
    BasicTest.BasicTest(forwarder, "README")
    RandomDisorderTest.RandomDisorderTest(forwarder, "README")
    SackRandomDisorderTest.SackRandomDisorderTest(forwarder, "README")
